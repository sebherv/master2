...
title({"Temps total d'exécution en mode Local"; "avec différents nombre d'échanges 1/2"});
xlabel("N");
...
title({"Temps total d'exécution en mode Local"; "avec différents nombre d'échanges 2/2"});
xlabel("N");
ylabel("Temps d'éxécution (s)");
