...
subplot(3,1,1);
plot(x0, nit, 'o-');
title("Gradiant Conjugué Pas Optimal pour f(x) pour n = 1");
xlabel("Valeur de x0");
...
subplot(3,1,2);
plot(x0, nit, 'o-');
title("Gradiant Conjugué Pas Optimal pour g(x) pour n = 1");
xlabel("Valeur de x0");
ylabel("Nombre d'itérations");
...
subplot(3,1,3);
plot(x0, nit, 'o-');
title("Gradiant Conjugué Pas Optimal pour f(x) pour n = 2");
